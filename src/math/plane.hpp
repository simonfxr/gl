...
MATH_FUNC plane3_t plane() PURE_FUNC;
...
MATH_FUNC plane3_t plane(const point3_t& a, const point3_t& b, const point3_t& c) PURE_FUNC;

MATH_FUNC plane3_t planeParametric(const point3_t& a, const vec3_t& u, const vec3_t& v) PURE_FUNC;
...
MATH_FUNC direction3_t transformNormal(const mat3_t& A, const direction3_t& n) PURE_FUNC;

MATH_FUNC plane3_t transform(const mat3_t& A, const plane3_t& P) PURE_FUNC;

MATH_FUNC plane3_t transform(const mat4_t& A, const plane3_t& P) PURE_FUNC;
