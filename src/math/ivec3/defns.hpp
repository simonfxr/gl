...
MATH_FUNC ivec3_t
ivec3(int32 x, int32 y, int32 z) PURE_FUNC;

MATH_FUNC ivec3_t
ivec3(int32 a) PURE_FUNC;

MATH_FUNC ivec3_t
ivec3(const vec3_t &a) PURE_FUNC;

MATH_FUNC ivec3_t
ivec3(const int32 a[3]) PURE_FUNC;
...
MATH_FUNC ivec3_t
operator/(const ivec3_t &v, int32 a) PURE_FUNC;
...
MATH_FUNC ivec3_t &
operator*=(ivec3_t &v, int32 a) MUT_FUNC;
