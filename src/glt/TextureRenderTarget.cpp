...
void TextureRenderTarget::resize(size w, size h) {
    ...
    ASSERT_MSG(buffers() & RT_COLOR_BUFFER, "TextureRenderTarget without Colorbuffer not supported");
...
bool TextureRenderTarget::checkFramebufferStatus(GLuint buffer, GLenum target) {
    GLenum status;
