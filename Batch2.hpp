...
public:
    ...
    explicit Batch2(GLenum primType, Attribute attribsToEnable = Vertex) :
...
inline Batch2::Attribute operator |(Batch2::Attribute a1, Batch2::Attribute a2) {
    return static_cast<Batch2::Attribute>(int64(a1) | int64(a2));
}
...
const Attrs<BatchVertex> Batch2::vertexAttrs(ARRAY_LENGTH(vertexAttrArray), vertexAttrArray);
